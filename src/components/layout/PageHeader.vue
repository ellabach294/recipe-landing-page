<template>
  <header>
    ...
    <div class="container header">
      <PageLogo class="siteid" />
      <NavBar />
      <!-- User and Search bar -->
      <div class="user">
        <div class="search-bar">
            <ChSearch v-if="!isMobile" class="search-icon" @click="toggleSearch"/>
            ...
            <transition name="slide-down">
              <div v-if="showSearch" class="search-overlay">
                <input 
                  ...
                  class="search-input"
                />
                <button class="close-search" @click="toggleSearch"><AnOutlinedClose/></button>
              </div>
            </transition>
        </div>

        <CaUserAvatarFilledAlt  class="user-icon"/>
      </div>
    </div>
  </header>
</template>
