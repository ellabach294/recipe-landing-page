    ...
    <div class="container footer">
      <div class="footer-info">
        <router-link to="/" class="footer-logo">
          <img src="@/assets/images/logo.png" alt="Footer Anthony Chef Logo">
        </router-link>
        <p>Stay In Touch</p>
        ...
        <button><router-link to="/recipes/submit-recipes">Submit Your Recipe</router-link></button>
      </div>
      ...
      <div class="footer-nav">
        ...
        <ul class="quick-links">
          ...
          <li><router-link to="/about">About Anthony</router-link></li>
          <li><router-link to="/recipes">Recipes</router-link></li>
          <li><router-link to="/quizzes">Quizzes</router-link></li>
          <li><router-link to="/protips">Pro Tips</router-link></li>
          <li><router-link to="/contact-us">Contact Us</router-link></li>
        </ul>
      </div>
  
      <p>For Educational Purpose. © 2025 Anthony The Chef. All rights reserved.</p>
    </div>
  </footer>
</template>
